...
- *(image)* stamp new manifests with the Manifest media type, not Config
- *(client)* set Content-Type header on manifest PUT
- *(layer)* verify blob digests using the actual algorithm, not always sha256
- address review findings in registry client and models

### Other

- bump dependencies
- *(deps)* bump dependencies
- *(deps)* update dependencies and fix keyring to 4.1

## [0.2.2](https://github.com/awslabs/ocilot/compare/v0.2.1...v0.2.2) - 2026-06-25

### Fixed

- *(registry)* ensure we use the keyring::v1 Entry

## [0.2.1](https://github.com/awslabs/ocilot/compare/v0.2.0...v0.2.1) - 2026-06-16

### Fixed

- *(manifest)* dispatch on mediaType when fetching manifests
